...
namespace Router
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            lblSys.Text = "硬件:"+GetDeviceInfo();
            if(GetDeviceInfo()!= "Raspberry Pi 3")
                SoundListen();
        }
        ...
        {
            if (Obj.Count == 0)
                lblDevMsgBox.Visibility = Visibility.Visible;
            else
                lblDevMsgBox.Visibility = Visibility.Collapsed;
        }//无设备指示
        ...
        private async Task<string> AyanLink()
        {
            string Str = await BegiRecongnize();
            return Str;
        }//识别服务
